...
(window, function() {
    ...
    function _removeEventListener(t, e) {
        if (e) {
            if (this._cbs[t]) {
                for (var s = 0, i = this._cbs[t].length; i > s; )
    ...
    function _triggerEvent(t, e) {
        if (this._cbs[t])
            for (var s = this._cbs[t].length, i = 0; s > i; i++)
                this._cbs[t][i](e)
    }
    ...
    function createElement(t, e, s) {
        if (!e) {
            var i = Object.create(t.prototype, s)
                , a = {};
            return i && "[object Function]" === a.toString.call(i.init) && i.init(),
                i
        }
    ...
    function bezFunction() {
        ...
        function a(t, e) {
            ...
            if (r == s[a].l)
                return s[a].p;
            for (var o = s[a].l > r ? -1 : 1, h = !0; h; )
                s[a].l <= r && s[a + 1].l > r ? (n = (r - s[a].l) / (s[a + 1].l - s[a].l),
                    h = !1) : a += o,
                (0 > a || a >= i - 1) && (h = !1);
        ...
        function n(t, e, s, i, n, o, h) {
            ...
            for (m = 0; d > m; m += 1)
                l.pt1[m] = c * c * c * t[m] + (p * c * c + c * p * c + c * c * p) * s[m] + (p * p * c + c * p * p + p * c * p) * i[m] + p * p * p * e[m],
                    l.pt3[m] = c * c * u * t[m] + (p * c * u + c * p * u + c * c * f) * s[m] + (p * p * u + c * p * f + p * c * f) * i[m] + p * p * f * e[m],
                    l.pt4[m] = c * u * u * t[m] + (p * u * u + c * f * u + c * u * f) * s[m] + (p * f * u + c * f * f + p * u * f) * i[m] + p * f * f * e[m],
                    l.pt2[m] = u * u * u * t[m] + (f * u * u + u * f * u + u * u * f) * s[m] + (f * f * u + u * f * f + f * u * f) * i[m] + f * f * f * e[m];
            return l
        }
        var o = (Math,
            function() {
                ...
                return function(s, i, a, r) {
                    ...
                    for (l = a.length,
                        ...
                        for (m = o / (d - 1),
                                 f = 0,
                                 h = 0; l > h; h += 1)
                            p = bm_pow(1 - m, 3) * s[h] + 3 * bm_pow(1 - m, 2) * m * a[h] + 3 * (1 - m) * bm_pow(m, 2) * r[h] + bm_pow(m, 3) * i[h],
                                u[h] = p,
                            null !== y[h] && (f += bm_pow(u[h] - y[h], 2)),
                                y[h] = u[h];
                        f && (f = bm_sqrt(f),
                            c += f),
                            v.segments.push(new t(c,m))
                    }
                    return v.addedLength = c,
                        e[n] = v,
                        v
                }
            }())
            ...
            return function(a) {
                ...
                for (f = o.length,
                    ...
                    for (y = new Array(f),
                             ...
                             u = 0,
                             m = 0; f > m; m += 1)
                        d = bm_pow(1 - c, 3) * r[m] + 3 * bm_pow(1 - c, 2) * c * (r[m] + o[m]) + 3 * (1 - c) * bm_pow(c, 2) * (n[m] + h[m]) + bm_pow(c, 3) * n[m],
                            y[m] = d,
                        null !== b && (u += bm_pow(y[m] - b[m], 2));
                    u = bm_sqrt(u),
                        g += u,
                        E.points[p] = new i(u,y),
                        b = y
                }
                E.segmentLength = g,
                    a.bezierData = E,
    ...
    function dataFunctionManager() {
                    ...
                    if (h.completed = !0,
                        ...
                        for (d = v.length,
                            ...
                            if (v[f].pt.k.i)
                                ...
                                for (u = v[f].pt.k.length,
                                         c = 0; u > c; c += 1)
                                    v[f].pt.k[c].s && i(v[f].pt.k[c].s[0]),
                                    v[f].pt.k[c].e && i(v[f].pt.k[c].e[0])
                    }
                    0 === h.ty ? (h.layers = e(h.refId, n),
                        t(h.layers, n, o)) : 4 === h.ty ? s(h.shapes, !1) : 5 == h.ty && r(h, o)
                }
        }
        function e(t, e) {
            for (var s = 0, i = e.length; i > s; ) {
                if (e[s].id === t)
                    return JSON.parse(JSON.stringify(e[s].layers));
                s += 1
            }
        }
        function s(t, e) {
            ...
            for (a = o - 1; a >= 0; a -= 1)
                if ("tm" == t[a].ty && (h = !0),
                    ...
                    if (t[a].trimmed = h,
                        ...
                        for (n = t[a].ks.k.length,
                                 r = 0; n > r; r += 1)
                            t[a].ks.k[r].s && i(t[a].ks.k[r].s[0]),
                            t[a].ks.k[r].e && i(t[a].ks.k[r].e[0]);
                else
                    "gr" == t[a].ty ? s(t[a].it, h) : ("el" == t[a].ty || "rc" == t[a].ty) && (t[a].trimmed = h)
        }
        function i(t) {
            var e, s = t.i.length;
            for (e = 0; s > e; e += 1)
        ...
        function r(t, e) {
            ...
            for (i = P.length,
                     s = 0; i > s; s += 1)
                "italic" === P[s].toLowerCase() ? S = "italic" : "bold" === P[s].toLowerCase() ? k = "700" : "black" === P[s].toLowerCase() ? k = "900" : "medium" === P[s].toLowerCase() ? k = "500" : "regular" === P[s].toLowerCase() || "normal" === P[s].toLowerCase() ? k = "400" : ("light" === P[s].toLowerCase() || "thin" === P[s].toLowerCase()) && (k = "200");
            if (p.fWeight = k,
                    p.fStyle = S,
                    i = p.t.length,
                    p.sz) {
                ...
                for (s = 0; i > s; s += 1)
                    a = !1,
                        " " === p.t.charAt(s) ? x = s : 13 === p.t.charCodeAt(s) && (v = 0,
                            a = !0),
                        e.chars ? (h = e.getCharData(p.t.charAt(s), b.fStyle, b.fFamily),
                            E = a ? 0 : h.w * p.s / 100) : E = e.measureText(p.t.charAt(s), p.f, p.s),
                        v + E > C ? (-1 === x ? (p.t = p.t.substr(0, s) + "\r" + p.t.substr(s),
                            i += 1) : (s = x,
            ...
            for (v = 0,
                     ...
                     s = 0; i > s; s += 1)
                if (a = !1,
                        " " === p.t.charAt(s) ? r = " " : 13 === p.t.charCodeAt(s) ? (y.push(v),
                            g = v > g ? v : g,
                            v = 0,
                            r = "",
                            a = !0,
                            u += 1) : r = p.t.charAt(s),
                        e.chars ? (h = e.getCharData(p.t.charAt(s), b.fStyle, e.getFontByName(p.f).fFamily),
                            E = a ? 0 : h.w * p.s / 100) : E = e.measureText(r, p.f, p.s),
                        v += E,
                        l.push({
                            l: E,
                            an: E,
            ...
            var D, T, M = [];
            for (n = 0; o > n; n += 1) {
                for (w[n].a.sc && (p.strokeColorAnim = !0),
                     w[n].a.sw && (p.strokeWidthAnim = !0),
                     (w[n].a.fc || w[n].a.fh || w[n].a.fs || w[n].a.fb) && (p.fillColorAnim = !0),
                         T = 0,
                         D = w[n].s.b,
                         s = 0; i > s; s += 1)
                    l[s].anIndexes[n] = T,
                    (1 == D && "" != l[s].val || 2 == D && "" != l[s].val && " " != l[s].val || 3 == D && (l[s].n || " " == l[s].val || s == i - 1) || 4 == D && (l[s].n || s == i - 1)) && (1 === w[n].s.rn && M.push(T),
                        T += 1);
                t.t.a[n].s.totalChars = T;
                var I, F = -1;
                if (1 === w[n].s.rn)
                    for (s = 0; i > s; s += 1)
                        F != l[s].anIndexes[n] && (F = l[s].anIndexes[n],
                            I = M.splice(Math.floor(Math.random() * M.length), 1)[0]),
                            l[s].anIndexes[n] = I
            }
    ...
    function CanvasRenderer(t, e) {
        ...
        var s, i = 15;
        for (s = 0; i > s; s += 1)
            this.contextData.saved[s] = new Array(16);
        this.elements = [],
    ...
    function MaskElement(t, e, s) {
        this.dynamicProperties = [],
            ...
            this.firstFrame = !0;
        var i, a, r, n, o, h, l, p, m = (this.element.maskedElement,
            this.globalData.defs), f = this.masksProperties.length, d = this.masksProperties, c = 0, u = [], y = randomString(10), v = "clipPath", g = "clip-path";
        for (i = 0; f > i; i++)
            if (("a" !== d[i].mode && "n" !== d[i].mode || d[i].inv) && (v = "mask",
                    g = "mask"),
                "s" != d[i].mode && "i" != d[i].mode || 0 != c || (o = document.createElementNS(svgNS, "rect"),
                ...
                if (c += 1,
                        ...
                        d[i].cl ? "s" == d[i].mode ? a.setAttribute("fill", "#000000") : a.setAttribute("fill", "#ffffff") : (a.setAttribute("fill", "none"),
                            "s" == d[i].mode ? a.setAttribute("fill", "#000000") : a.setAttribute("fill", "#ffffff"),
                    ...
                    v = "mask",
                        g = "mask",
                        p = PropertyFactory.getProp(this.element, d[i].x, 0, null , this.dynamicProperties);
                    ...
                    h = document.createElementNS(svgNS, "filter"),
                        ...
                        h.appendChild(l),
                        m.appendChild(h),
                        "s" == d[i].mode ? a.setAttribute("stroke", "#000000") : a.setAttribute("stroke", "#ffffff")
                } else
                    l = null ,
                        p = null ;
        ...
        for (this.maskElement = document.createElementNS(svgNS, v),
                 f = u.length,
                 i = 0; f > i; i += 1)
            this.maskElement.appendChild(u[i]);
        this.maskElement.setAttribute("id", y),
        c > 0 && this.element.maskedElement.setAttribute(g, "url(#" + y + ")"),
    ...
    function EffectsManager(t, e, s) {
        ...
        for (a = 0; n > a; a++)
            switch (i[a].ty) {
                case 0:
                    r = new SliderEffect(i[a],e,s),
                        this.effectElements.push(r.proxyFunction.bind(r));
                    break;
                case 1:
                    r = new AngleEffect(i[a],e,s),
                        this.effectElements.push(r.proxyFunction.bind(r));
                    break;
                case 2:
                    r = new ColorEffect(i[a],e,s),
                        this.effectElements.push(r.proxyFunction.bind(r));
                    break;
                case 3:
                    r = new PointEffect(i[a],e,s),
                        this.effectElements.push(r.proxyFunction.bind(r));
                    break;
                case 4:
                    r = new CheckboxEffect(i[a],e,s),
                        this.effectElements.push(r.proxyFunction.bind(r))
            }
    }
    ...
    function SVGBaseElement(t, e, s, i, a) {
        this.globalData = s,
            ...
            this.layerId = a ? a.layerId : "ly_" + randomString(10),
            this.placeholder = a,
            this.init()
    }
    ...
    function HCameraElement(t, e, s, i, a) {
        if (this.parent.constructor.call(this, t, e, s, i, a),
    ...
    var rgbToHex = function() {
        ...
        function m(t, e, s, i, a, r, n, o, h, l, p, m, f, d, c, u) {
            if (1 === t && 0 === e && 0 === s && 0 === i && 0 === a && 1 === r && 0 === n && 0 === o && 0 === h && 0 === l && 1 === p && 0 === m)
                return (0 !== f || 0 !== d || 0 !== c) && (this.props[12] = this.props[12] * t + this.props[13] * a + this.props[14] * h + this.props[15] * f,
                    this.props[13] = this.props[12] * e + this.props[13] * r + this.props[14] * l + this.props[15] * d,
                    this.props[14] = this.props[12] * s + this.props[13] * n + this.props[14] * p + this.props[15] * c,
            ...
            var y = this.props[0]
                ...
                , I = this.props[14]
                , F = this.props[15];
            return this.props[0] = y * t + v * a + g * h + b * f,
                this.props[1] = y * e + v * r + g * l + b * d,
                this.props[2] = y * s + v * n + g * p + b * c,
                this.props[3] = y * i + v * o + g * m + b * u,
                this.props[4] = E * t + P * a + k * h + S * f,
                this.props[5] = E * e + P * r + k * l + S * d,
                this.props[6] = E * s + P * n + k * p + S * c,
                this.props[7] = E * i + P * o + k * m + S * u,
                this.props[8] = C * t + x * a + w * h + D * f,
                this.props[9] = C * e + x * r + w * l + D * d,
                this.props[10] = C * s + x * n + w * p + D * c,
                this.props[11] = C * i + x * o + w * m + D * u,
                this.props[12] = T * t + M * a + I * h + F * f,
                this.props[13] = T * e + M * r + I * l + F * d,
                this.props[14] = T * s + M * n + I * p + F * c,
                this.props[15] = T * i + M * o + I * m + F * u,
                this
        }
        function f(t) {
            var e;
    ...
    !function(t, e) {
        ...
        function i(t) {
            ...
            for (s || (t = [s++]); m > a; )
                n[a] = a++;
            for (a = 0; m > a; a++)
                n[a] = n[r = g & r + t[a % s] + (e = n[a])],
                    n[r] = e;
            (i.g = function(t) {
                    for (var e, s = 0, a = i.i, r = i.j, n = i.S; t--; )
                        e = n[a = g & a + 1],
                            s = s * m + n[g & (n[a] = n[r = g & r + e]) + (n[r] = e)];
                    return i.i = a,
                        i.j = r,
                        s
                }
        ...
        function n(t, e) {
            for (var s, i = t + "", a = 0; a < i.length; )
                e[g & a] = g & (s ^= 19 * e[g & a]) + i.charCodeAt(a++);
            return h(e)
        }
        function o() {
            try {
        ...
        function n(t, e, s, i, r) {
            ...
            do
                o = e + (s - e) / 2,
                    n = a(o, i, r) - t,
                    n > 0 ? s = o : e = o;
            while (Math.abs(n) > d && ++h < c);return o
        }
        function o(t, e, s, i) {
            for (var n = 0; m > n; ++n) {
                var o = r(e, s, i);
        ...
        return h.prototype = {
            get: function(t) {
                ...
                return this._precomputed || this._precompute(),
                    e === s && i === r ? t : 0 === t ? 0 : 1 === t ? 1 : a(this._getTForX(t), s, r)
            },
            ...
            _calcSampleValues: function() {
                for (var t = this._p[0], e = this._p[2], s = 0; u > s; ++s)
                    this._mSampleValues[s] = a(s * y, t, e)
            },
            _getTForX: function(t) {
                for (var e = this._p[0], s = this._p[2], i = this._mSampleValues, a = 0, h = 1, l = u - 1; h !== l && i[h] <= t; ++h)
                    a += y;
                --h;
    ...
    var bez = bezFunction()
        ...
        function i(i, a) {
            ...
            for (r = 0; o > r; r += 1) {
                if (n[r].loaded = !1,
                        n[r].monoCase = t(n[r].fFamily, "monospace"),
                        n[r].sansCase = t(n[r].fFamily, "sans-serif"),
                        n[r].fPath) {
                    if ("p" === n[r].fOrigin) {
                        var h = document.createElement("style");
                        h.type = "text/css",
                            h.innerHTML = "@font-face {font-family: " + n[r].fFamily + "; font-style: normal; src: url('" + n[r].fPath + "');}",
                            a.appendChild(h)
        ...
        function a(t) {
            if (t) {
                ...
                for (e = 0; a > e; e += 1) {
                    for (s = 0,
                             i = !1; r > s; )
                        this.chars[s].style === t[e].style && this.chars[s].fFamily === t[e].fFamily && this.chars[s].ch === t[e].ch && (i = !0),
                            s += 1;
        ...
        var h = 5e3
            ...
            ;
        return l.prototype.addChars = a,
            l.prototype.addFonts = i,
            l.prototype.getCharData = r,
        ...
        function sum(t, e) {
            var s = typeof t
                , i = typeof e;
            if (!("number" !== s && "boolean" !== s || "number" !== i && "boolean" !== i))
                return t + e;
            ...
            if ("object" === s && "object" === i) {
                for (var a = 0, r = t.length, n = e.length, o = []; r > a || n > a; )
                    o[a] = "number" == typeof t[a] && "number" == typeof e[a] ? t[a] + e[a] : t[a] || e[a],
                        a += 1;
                return o
            }
            return 0
        ...
        function initiateExpression(elem, data) {
            ...
            function execute() {
                ...
                !content && elem.content && (content = elem.content.bind(elem)),
            ...
            var bindedFn = fn.bind(this)
                ...
                , wiggle = function(t, e) {
                var s, i, a = this.pv.length ? this.pv.length : 1, r = Array.apply(null , {
                    len: a
                });
                for (i = 0; a > i; i += 1)
                    r[i] = 0;
                ...
                for (i = 0; a > i; i += 1)
                    l[i] = this.pv[i] + r[i] + (-e + 2 * e * BMMath.random()) * h;
                return l
            }
                .bind(this)
                ...
                if (i >= r)
                    return this.pv;
                var n, o;
                s ? (n = e ? Math.abs(thisComp.globalData.frameRate * e) : Math.max(0, this.elem.data.op - r),
                    o = r + n) : ((!e || e > a.length - 1) && (e = a.length - 1),
                    o = a[e].t,
                    n = o - r);
                var h, l, p;
                if ("pingpong" === t) {
                    ...
                    if (m % 2 === 0)
                        return this.getValueAtTime((r - i) % n + r)
                } else {
                    if ("offset" === t) {
                ...
                if (r >= i)
                    return this.pv;
                var n, o;
                s ? (n = e ? Math.abs(r - thisComp.globalData.frameRate * e) : Math.max(0, r - this.elem.data.ip),
                    o = r - n) : ((!e || e > a.length - 1) && (e = a.length - 1),
                    o = a[a.length - 1 - e].t,
                    n = r - o);
                var h, l, p;
                if ("pingpong" === t) {
                    ...
                    if (m % 2 !== 0)
                        return this.getValueAtTime(n - (i - o) % n + o)
                } else {
                    if ("offset" === t) {
    ...
    !function() {
        ...
        ShapeInterface.prototype.fillInterface = function(t) {
            var e = {
                get color() {
                    return t.c.k && t.c.getValue(),
                        [t.c.pv[0], t.c.pv[1], t.c.pv[2]]
                },
                get opacity() {
                    return t.o.k && t.o.getValue(),
                        t.o.pv
                }
            };
            return e
        ...
        ShapeInterface.prototype.strokeInterface = function(t, e) {
            var s = {
                ...
                get dash() {
                    ...
                    for (s = 0; r > s; s += 1)
                        i.dataProps[s].p.k && i.dataProps[s].p.getValue(),
                            this.dashOb[a[s].nm] = i.dataProps[s].p.v;
                    return this.dashOb
                }
            };
            return s
        ...
        ShapeInterface.prototype.ellipseInterface = function(t) {
            var e = {
                get size() {
                    return t.sh.s.k && t.sh.s.getValue(),
                        [t.sh.s.pv[0], t.sh.s.pv[1]]
                },
                get position() {
                    return t.sh.p.k && t.sh.p.getValue(),
                        [t.sh.p.pv[0], t.sh.p.pv[1]]
                }
            };
            return e
        }
        ...
        ShapeInterface.prototype.rectangleInterface = function(t) {
            var e = "tm" === t.sh.ty ? t.sh.prop : t.sh
                ...
                get position() {
                    return e.p.k && e.p.getValue(),
                        [e.p.pv[0], e.p.pv[1]]
                },
                get roundness() {
                    return e.r.k && e.r.getValue(),
                        e.r.pv
                }
            };
            return s
        ...
        ShapeInterface.prototype.trimInterface = function(t) {
            var e = {
                get start() {
                    return t.tr.s.k && t.tr.s.getValue(),
                        t.tr.s.pv
                },
                get end() {
                    return t.tr.e.k && t.tr.e.getValue(),
                        t.tr.e.pv
                },
                get offset() {
                    return t.tr.o.k && t.tr.o.getValue(),
                        t.tr.o.pv
                }
            };
            return e
        ...
        ShapeInterface.prototype.transformInterface = function(t) {
            var e = {
                get opacity() {
                    return t.transform.mProps.o.k && t.transform.mProps.o.getValue(),
                        t.transform.mProps.o.pv
                },
                get position() {
                    return t.transform.mProps.p.k && t.transform.mProps.p.getValue(),
                        [t.transform.mProps.p.pv[0], t.transform.mProps.p.pv[1]]
                },
                get anchorPoint() {
                    return t.transform.mProps.a.k && t.transform.mProps.a.getValue(),
                        [t.transform.mProps.a.pv[0], t.transform.mProps.a.pv[1]]
                },
                get scale() {
                    return t.transform.mProps.s.k && t.transform.mProps.s.getValue(),
                        [t.transform.mProps.s.pv[0], t.transform.mProps.s.pv[1]]
                },
                get rotation() {
                    return t.transform.mProps.r.k && t.transform.mProps.r.getValue(),
                        t.transform.mProps.r.pv
                },
                get skew() {
                    return t.transform.mProps.sk.k && t.transform.mProps.sk.getValue(),
                        t.transform.mProps.sk.pv
                },
                get skewAxis() {
                    return t.transform.mProps.sa.k && t.transform.mProps.sa.getValue(),
                        t.transform.mProps.sa.pv
                }
            };
            return e
        }
        ...
        ShapeInterface.prototype.groupInterface = function(t, e, s) {
            ...
            for (i = 0; n > i; i += 1)
                "gr" === t[i].ty ? (a = {},
                    this.groupInterface(t[i].it, e[i].it, a),
                    r.push(a)) : "sh" === t[i].ty ? (a = this.shapeInterface(e[i]),
                    r.push(a)) : "fl" === t[i].ty ? (a = this.fillInterface(e[i]),
                    r.push(a)) : "st" === t[i].ty ? (a = this.strokeInterface(t[i], e[i]),
                    r.push(a)) : "el" === t[i].ty ? (a = this.ellipseInterface(e[i]),
                    r.push(a)) : "rc" === t[i].ty ? (a = this.rectangleInterface(e[i]),
                    r.push(a)) : "tr" === t[i].ty ? s.transform = this.transformInterface(e[i]) : "tm" === t[i].ty ? (a = this.trimInterface(e[i]),
                    r.push(a)) : r.push("");
        ...
        LayerInterface.prototype.toWorld = function(t) {
            if (this.hierarchy && this.hierarchy.length) {
                ...
                for (this.finalTransform.mProp.applyToMatrix(s, !1),
                         e = 0; i > e; e += 1)
                    this.hierarchy[e].finalTransform.mProp.applyToMatrix(s, !0);
    ...
    var PropertyFactory = function() {
        function t(t) {
            ...
            if (e.to) {
                ...
                if (t >= s.t - o || t < e.t - o) {
                    ...
                    e.__fnct ? d = e.__fnct : (d = BezierFactory.getBezierEasing(e.o.x, e.o.y, e.i.x, e.i.y, e.n).get,
                        e.__fnct = d),
                    ...
                    for (r = 1,
                             n = !0,
                             f = u.points.length; n; ) {
                        if (b += u.points[c].partialLength * r,
                            0 === g || 0 === m || c == u.points.length - 1) {
                            for (p = u.points[c].point.length,
                                     l = 0; p > l; l += 1)
                                h[l] = u.points[c].point[l];
                            break
                        }
                        if (g >= b && g < b + u.points[c + 1].partialLength) {
                            for (v = (g - b) / u.points[c + 1].partialLength,
                                     p = u.points[c].point.length,
                                     l = 0; p > l; l += 1)
                                h[l] = u.points[c].point[l] + (u.points[c + 1].point[l] - u.points[c].point[l]) * v;
                            break
                        }
                ...
                for (a = e.s.length,
                         i = 0; a > i; i += 1) {
                    if (1 !== e.h && (e.o.x instanceof Array ? (x = !0,
                        e.__fnct || (e.__fnct = []),
                        e.__fnct[i] || (E = e.o.x[i] || e.o.x[0],
                            P = e.o.y[i] || e.o.y[0],
                            k = e.i.x[i] || e.i.x[0],
                            S = e.i.y[i] || e.i.y[0])) : (x = !1,
                        e.__fnct || (E = e.o.x,
                            P = e.o.y,
                            k = e.i.x,
                            S = e.i.y)),
                            x ? e.__fnct[i] ? d = e.__fnct[i] : (d = BezierFactory.getBezierEasing(E, P, k, S).get,
                                e.__fnct[i] = d) : e.__fnct ? d = e.__fnct : (d = BezierFactory.getBezierEasing(E, P, k, S).get,
                                e.__fnct = d),
                            m = t >= s.t - o ? 1 : t < e.t - o ? 0 : d((t - (e.t - o)) / (s.t - o - (e.t - o)))),
                        this.sh && 1 !== e.h) {
                        var w = e.s[i]
                            , D = e.e[i];
                        -180 > w - D ? w += 360 : w - D > 180 && (w -= 360),
                            C = w + (D - w) * m
                    } else
                        C = 1 === e.h ? e.s[i] : e.s[i] + (e.e[i] - e.s[i]) * m;
                    1 === a ? h = C : h[i] = C
                }
            }
            return h
        ...
        function e(t) {
            ...
            if (i.length) {
                ...
                for (r = 0; r < i.length; r += 1)
                    e[r] = this.elem.globalData.frameRate * ((a[r] - i[r]) / s)
            } else
                e = (a - i) / s;
            return e
        }
                ...
                if (t === this.lastFrame || this.lastFrame !== y && (this.lastFrame >= this.keyframes[this.keyframes.length - 1].t - this.offsetTime && t >= this.keyframes[this.keyframes.length - 1].t - this.offsetTime || this.lastFrame < this.keyframes[0].t - this.offsetTime && t < this.keyframes[0].t - this.offsetTime))
                    ...
                    if (e.to) {
                        ...
                        if (t >= s.t - this.offsetTime || t < e.t - this.offsetTime) {
                            ...
                            for (h = d.points[c].point.length,
                                     o = 0; h > o; o += 1)
                                this.v[o] = this.mult ? d.points[c].point[o] * this.mult : d.points[c].point[o],
                                    this.pv[o] = d.points[c].point[o],
                                this.lastPValue[o] !== this.pv[o] && (this.mdf = !0,
                                    this.lastPValue[o] = this.pv[o])
                        } else {
                            e.__fnct ? m = e.__fnct : (m = BezierFactory.getBezierEasing(b, E, P, k, e.n).get,
                                e.__fnct = m),
                                l = m((t - (e.t - this.offsetTime)) / (s.t - this.offsetTime - (e.t - this.offsetTime)));
                            var u, v = d.segmentLength * l, g = 0;
                            for (r = 1,
                                     n = !0,
                                     p = d.points.length; n; ) {
                                if (g += d.points[f].partialLength * r,
                                    0 === v || 0 === l || f == d.points.length - 1) {
                                    for (h = d.points[f].point.length,
                                             o = 0; h > o; o += 1)
                                        this.v[o] = this.mult ? d.points[f].point[o] * this.mult : d.points[f].point[o],
                                            this.pv[o] = d.points[f].point[o],
                                        this.lastPValue[o] !== this.pv[o] && (this.mdf = !0,
                                            this.lastPValue[o] = this.pv[o]);
                                    break
                                }
                                if (v >= g && v < g + d.points[f + 1].partialLength) {
                                    for (u = (v - g) / d.points[f + 1].partialLength,
                                             h = d.points[f].point.length,
                                             o = 0; h > o; o += 1)
                                        this.v[o] = this.mult ? (d.points[f].point[o] + (d.points[f + 1].point[o] - d.points[f].point[o]) * u) * this.mult : d.points[f].point[o] + (d.points[f + 1].point[o] - d.points[f].point[o]) * u,
                                            this.pv[o] = d.points[f].point[o] + (d.points[f + 1].point[o] - d.points[f].point[o]) * u,
                                        this.lastPValue[o] !== this.pv[o] && (this.mdf = !0,
                                            this.lastPValue[o] = this.pv[o]);
                                    break
                                }
                        ...
                        for (a = e.s.length,
                                 i = 0; a > i; i += 1) {
                            if (1 !== e.h && (e.o.x instanceof Array ? (C = !0,
                                e.__fnct || (e.__fnct = []),
                                e.__fnct[i] || (b = e.o.x[i] || e.o.x[0],
                                    E = e.o.y[i] || e.o.y[0],
                                    P = e.i.x[i] || e.i.x[0],
                                    k = e.i.y[i] || e.i.y[0])) : (C = !1,
                                e.__fnct || (b = e.o.x,
                                    E = e.o.y,
                                    P = e.i.x,
                                    k = e.i.y)),
                                    C ? e.__fnct[i] ? m = e.__fnct[i] : (m = BezierFactory.getBezierEasing(b, E, P, k).get,
                                        e.__fnct[i] = m) : e.__fnct ? m = e.__fnct : (m = BezierFactory.getBezierEasing(b, E, P, k).get,
                                        e.__fnct = m),
                                    l = t >= s.t - this.offsetTime ? 1 : t < e.t - this.offsetTime ? 0 : m((t - (e.t - this.offsetTime)) / (s.t - this.offsetTime - (e.t - this.offsetTime)))),
                                this.sh && 1 !== e.h) {
                                var x = e.s[i]
                                    , w = e.e[i];
                                -180 > x - w ? x += 360 : x - w > 180 && (x -= 360),
                                    S = x + (w - x) * l
                            } else
                                S = 1 === e.h ? e.s[i] : e.s[i] + (e.e[i] - e.s[i]) * l;
                            1 === a ? (this.v = this.mult ? S * this.mult : S,
                                this.pv = S,
                            this.lastPValue != this.pv && (this.mdf = !0,
                                this.lastPValue = this.pv)) : (this.v[i] = this.mult ? S * this.mult : S,
                                this.pv[i] = S,
                            this.lastPValue[i] !== this.pv[i] && (this.mdf = !0,
        ...
        function i() {
            ...
            if (this.lastFrame !== y && (this.lastFrame < this.keyframes[0].t - this.offsetTime && t < this.keyframes[0].t - this.offsetTime || this.lastFrame > this.keyframes[this.keyframes.length - 1].t - this.offsetTime && t > this.keyframes[this.keyframes.length - 1].t - this.offsetTime))
                ...
                if (t < this.keyframes[0].t - this.offsetTime)
                    ...
                    this.mdf = !0,
                        e = 1 === this.keyframes[this.keyframes.length - 2].h ? this.keyframes[this.keyframes.length - 2].s[0] : this.keyframes[this.keyframes.length - 2].e[0],
                        i = !0;
                else {
                    this.mdf = !0;
                    for (var a, r, n, o, h, l, p = 0, m = this.keyframes.length - 1, f = 1, d = !0; d && (a = this.keyframes[p],
                        r = this.keyframes[p + 1],
                        !(r.t - this.offsetTime > t && 1 == f)); )
                        m - 1 > p && 1 == f || p > 0 && -1 == f ? p += f : d = !1;
                    var c;
                    if (1 !== a.h) {
                        var u;
                        a.__fnct ? u = a.__fnct : (u = BezierFactory.getBezierEasing(a.o.x, a.o.y, a.i.x, a.i.y).get,
                            a.__fnct = u),
                            c = t >= r.t - this.offsetTime ? 1 : t < a.t - this.offsetTime ? 0 : u((t - (a.t - this.offsetTime)) / (r.t - this.offsetTime - (a.t - this.offsetTime))),
                            s = a.e[0]
                    }
                    e = a.s[0],
                        i = 1 === a.h
                }
                for (o = this.v.i.length,
                         l = e.i[0].length,
                         n = 0; o > n; n += 1)
                    for (h = 0; l > h; h += 1)
                        i ? (this.v.i[n][h] = e.i[n][h],
                            this.v.o[n][h] = e.o[n][h],
                            this.v.v[n][h] = e.v[n][h],
                            this.pv.i[n][h] = e.i[n][h],
                            this.pv.o[n][h] = e.o[n][h],
                            this.pv.v[n][h] = e.v[n][h]) : (this.v.i[n][h] = e.i[n][h] + (s.i[n][h] - e.i[n][h]) * c,
                            this.v.o[n][h] = e.o[n][h] + (s.o[n][h] - e.o[n][h]) * c,
                            this.v.v[n][h] = e.v[n][h] + (s.v[n][h] - e.v[n][h]) * c,
                            this.pv.i[n][h] = e.i[n][h] + (s.i[n][h] - e.i[n][h]) * c,
                            this.pv.o[n][h] = e.o[n][h] + (s.o[n][h] - e.o[n][h]) * c,
                            this.pv.v[n][h] = e.v[n][h] + (s.v[n][h] - e.v[n][h]) * c)
            }
            this.lastFrame = t
        }
        function a(t, e) {
            ...
            this.getValue && (this.getPreValue = this.getValue),
                this.getValue = this.getExpression(t, e))
        }
        function r(t, e, s) {
            this.mult = s,
                this.v = s ? e.k * s : e.k,
        ...
        function o(i, r, n) {
            this.keyframes = r.k,
                ...
                this.comp = i.comp,
                this.lastFrame = y,
                this.v = n ? r.k[0].s[0] * n : r.k[0].s[0],
                this.pv = r.k[0].s[0],
                this.getValue = s,
                this.getValueAtTime = t,
                this.getVelocityAtTime = e,
                a.bind(this)(i, r)
        }
        function h(i, r, n) {
            var o, h, l, p, m, f = r.k.length;
            for (o = 0; f - 1 > o; o += 1)
                r.k[o].to && r.k[o].s && r.k[o].e && (h = r.k[o].s,
                    l = r.k[o].e,
                    p = r.k[o].to,
                    m = r.k[o].ti,
                (2 == h.length && bez.pointOnLine2D(h[0], h[1], l[0], l[1], h[0] + p[0], h[1] + p[1]) && bez.pointOnLine2D(h[0], h[1], l[0], l[1], l[0] + m[0], l[1] + m[1]) || bez.pointOnLine3D(h[0], h[1], h[2], l[0], l[1], l[2], h[0] + p[0], h[1] + p[1], h[2] + p[2]) && bez.pointOnLine3D(h[0], h[1], h[2], l[0], l[1], l[2], l[0] + m[0], l[1] + m[1], l[2] + m[2])) && (r.k[o].to = null ,
                    r.k[o].ti = null ));
            this.keyframes = r.k,
                this.offsetTime = i.data.st,
                this.k = !0,
                ...
                this.getVelocityAtTime = e,
                this.frameId = -1,
                this.v = new Array(r.k[0].s.length),
                this.pv = new Array(r.k[0].s.length),
                this.lastValue = new Array(r.k[0].s.length),
                this.lastPValue = new Array(r.k[0].s.length),
                this.lastFrame = y,
                a.bind(this)(i, r)
        }
        ...
        function m(t, e, s) {
            this.comp = t.comp,
                this.k = !1,
                this.mdf = !1,
                this.closed = 3 === s ? e.cl : e.closed,
                this.numNodes = 3 === s ? e.pt.k.v.length : e.ks.k.v.length,
                this.v = 3 === s ? e.pt.k : e.ks.k;
            var i = 3 === s ? e.pt : e.ks;
            this.getValue = p,
                this.pv = this.v,
                a.bind(this)(t, i)
        ...
        function f(t, e, s) {
            ...
            for (this.numNodes = n,
                     ...
                     r = 0; n > r; r += 1)
                this.v.i[r] = new Array(o),
                    this.v.o[r] = new Array(o),
                    this.v.v[r] = new Array(o),
                    this.pv.i[r] = new Array(o),
                    this.pv.o[r] = new Array(o),
                    this.pv.v[r] = new Array(o);
            this.lastFrame = y;
            var h = 3 === s ? e.pt : e.ks;
            a.bind(this)(t, h)
        }
        function d(t, e, s, i, a) {
            ...
            if (3 === s || 4 === s) {
                ...
                5 === s ? r = new E(t,e) : 6 === s ? r = new g(t,e) : 7 === s && (r = new b(t,e));
            var o = !1;
            if (a)
        ...
        var y = -999999
            , v = function() {
            function t() {
                return this.p.k && this.getValue(),
                    this.p.pv
            }
            function e() {
                return this.a.k && this.getValue(),
                    this.a.pv
            }
            function s() {
                return this.or.k && this.getValue(),
                    this.or.pv
            }
            function i() {
                return this.r.k && this.getValue(),
                    this.r.pv
            }
            function a() {
                return this.s.k && this.getValue(),
                    this.s.pv
            }
            function r() {
            ...
            function h(t, e) {
                ...
                if (e) {
                    for (s = 0; i > s; s += 1)
                        ...
                        this.dynamicProperties[s].mdf && (this.mdf = !0);
                    this.a && t.translate(-this.a.v[0], -this.a.v[1], this.a.v[2]),
                    this.s && t.scale(this.s.v[0], this.s.v[1], this.s.v[2]),
                        this.r ? t.rotate(-this.r.v) : t.rotateZ(-this.rz.v).rotateY(this.ry.v).rotateX(this.rx.v).rotateZ(-this.or.v[2]).rotateY(this.or.v[1]).rotateX(this.or.v[0]),
                        this.data.p.s ? this.data.p.z ? t.translate(this.px.v, this.py.v, -this.pz.v) : t.translate(this.px.v, this.py.v, 0) : t.translate(this.p.v[0], this.p.v[1], -this.p.v[2])
                } else
                    this.a && t.translate(-this.a.pv[0], -this.a.pv[1], this.a.pv[2]),
                    this.s && t.scale(this.s.pv[0], this.s.pv[1], this.s.pv[2]),
                        this.r ? t.rotate(-this.r.pv) : t.rotateZ(-this.rz.pv).rotateY(this.ry.pv).rotateX(this.rx.pv).rotateZ(-this.or.pv[2]).rotateY(this.or.pv[1]).rotateX(this.or.pv[0]),
                        this.data.p.s ? this.data.p.z ? t.translate(this.px.pv, this.py.pv, -this.pz.pv) : t.translate(this.px.pv, this.py.pv, 0) : t.translate(this.p.pv[0], this.p.pv[1], -this.p.pv[2])
            }
            function p() {
                if (this.elem.globalData.frameId !== this.frameId) {
                    this.mdf = !1,
            ...
            return function(f, d, c) {
                this.elem = f,
                    ...
                    this.setInverted = m,
                    this.v = new Matrix,
                    d.p.s ? (this.px = l(f, d.p.x, 0, 0, this.dynamicProperties),
                        this.py = l(f, d.p.y, 0, 0, this.dynamicProperties),
                    d.p.z && (this.pz = l(f, d.p.z, 0, 0, this.dynamicProperties))) : this.p = l(f, d.p, 1, 0, this.dynamicProperties),
                    d.r ? this.r = l(f, d.r, 0, degToRads, this.dynamicProperties) : d.rx && (this.rx = l(f, d.rx, 0, degToRads, this.dynamicProperties),
                        this.ry = l(f, d.ry, 0, degToRads, this.dynamicProperties),
                        this.rz = l(f, d.rz, 0, degToRads, this.dynamicProperties),
                        this.or = l(f, d.or, 0, degToRads, this.dynamicProperties)),
                d.sk && (this.sk = l(f, d.sk, 0, degToRads, this.dynamicProperties),
                    this.sa = l(f, d.sa, 0, degToRads, this.dynamicProperties)),
                d.a && (this.a = l(f, d.a, 1, 0, this.dynamicProperties)),
                d.s && (this.s = l(f, d.s, 1, .01, this.dynamicProperties)),
                    this.o = d.o ? l(f, d.o, 0, .01, c) : {
                        mdf: !1,
                        v: 1
                    },
                    this.dynamicProperties.length ? c.push(this) : (this.a && this.v.translate(-this.a.v[0], -this.a.v[1], this.a.v[2]),
                    this.s && this.v.scale(this.s.v[0], this.s.v[1], this.s.v[2]),
                    this.sk && this.v.skewFromAxis(-this.sk.v, this.sa.v),
                        this.r ? this.v.rotate(-this.r.v) : this.v.rotateZ(-this.rz.v).rotateY(this.ry.v).rotateX(this.rx.v).rotateZ(-this.or.v[2]).rotateY(this.or.v[1]).rotateX(this.or.v[0]),
                        this.data.p.s ? d.p.z ? this.v.translate(this.px.v, this.py.v, -this.pz.v) : this.v.translate(this.px.v, this.py.v, 0) : this.v.translate(this.p.v[0], this.p.v[1], -this.p.v[2])),
            ...
            function t() {
                var t = this.p.v[0]
                    ...
                    , i = this.s.v[0] / 2
                    , a = this.s.v[1] / 2;
                2 !== this.d && 3 !== this.d ? (this.v.v[0] = [t, e - a],
                    this.v.i[0] = [t - i * s, e - a],
                    this.v.o[0] = [t + i * s, e - a],
                    this.v.v[1] = [t + i, e],
                    this.v.i[1] = [t + i, e - a * s],
                    this.v.o[1] = [t + i, e + a * s],
                    this.v.v[2] = [t, e + a],
                    this.v.i[2] = [t + i * s, e + a],
                    this.v.o[2] = [t - i * s, e + a],
                    this.v.v[3] = [t - i, e],
                    this.v.i[3] = [t - i, e + a * s],
                    this.v.o[3] = [t - i, e - a * s]) : (this.v.v[0] = [t, e - a],
                    this.v.o[0] = [t - i * s, e - a],
                    this.v.i[0] = [t + i * s, e - a],
                    this.v.v[1] = [t - i, e],
                    this.v.o[1] = [t - i, e + a * s],
            ...
            return function(s, i) {
                this.v = {
                    ...
                    this.p = l(s, i.p, 1, 0, this.dynamicProperties),
                    this.s = l(s, i.s, 1, 0, this.dynamicProperties),
            ...
            function t() {
                ...
                for (n += this.r.v,
                    ...
                    h += +this.p.v[0],
                        l += +this.p.v[1],
                        this.v.v[s] = [h, l],
                        this.v.i[s] = [h + p * r * a * o, l + m * r * a * o],
                        this.v.o[s] = [h - p * r * a * o, l - m * r * a * o],
                        n += e * o
                }
                this.numNodes = t
            }
            function e() {
                ...
                for (s = 0; t > s; s += 1) {
                    ...
                    u += +this.p.v[0],
                        y += +this.p.v[1],
                        this.v.v[s] = [u, y],
                        this.v.i[s] = [u + v * r * a * c, y + g * r * a * c],
                        this.v.o[s] = [u - v * r * a * c, y - g * r * a * c],
                        n = !n,
                        d += e * c
                }
                this.numNodes = t
            ...
            return function(i, a) {
                this.v = {
                    ...
                    this.closed = !0,
                    this.getValue = s,
                    1 === a.sy ? (this.ir = l(i, a.ir, 0, 0, this.dynamicProperties),
                        this.is = l(i, a.is, 0, .01, this.dynamicProperties),
                        this.convertToPath = e) : this.convertToPath = t,
                    this.pt = l(i, a.pt, 0, 0, this.dynamicProperties),
                    this.p = l(i, a.p, 1, 0, this.dynamicProperties),
                    this.r = l(i, a.r, 0, degToRads, this.dynamicProperties),
                    this.or = l(i, a.or, 0, 0, this.dynamicProperties),
                    this.os = l(i, a.os, 0, .01, this.dynamicProperties),
            ...
            function e() {
                var t = this.p.v[0]
                    ...
                    , r = a * (1 - .5519);
                2 === this.d || 1 === this.d ? (this.v.v[0] = [t + s, e - i + a],
                    this.v.o[0] = this.v.v[0],
                    this.v.i[0] = [t + s, e - i + r],
                    this.v.v[1] = [t + s, e + i - a],
                    this.v.o[1] = [t + s, e + i - r],
                    this.v.i[1] = this.v.v[1],
                    this.v.v[2] = [t + s - a, e + i],
                    this.v.o[2] = this.v.v[2],
                    this.v.i[2] = [t + s - r, e + i],
                    this.v.v[3] = [t - s + a, e + i],
                    this.v.o[3] = [t - s + r, e + i],
                    this.v.i[3] = this.v.v[3],
                    this.v.v[4] = [t - s, e + i - a],
                    this.v.o[4] = this.v.v[4],
                    this.v.i[4] = [t - s, e + i - r],
                    this.v.v[5] = [t - s, e - i + a],
                    this.v.o[5] = [t - s, e - i + r],
                    this.v.i[5] = this.v.v[5],
                    this.v.v[6] = [t - s + a, e - i],
                    this.v.o[6] = this.v.v[6],
                    this.v.i[6] = [t - s + r, e - i],
                    this.v.v[7] = [t + s - a, e - i],
                    this.v.o[7] = [t + s - r, e - i],
                    this.v.i[7] = this.v.v[7]) : (this.v.v[0] = [t + s, e - i + a],
                    this.v.o[0] = [t + s, e - i + r],
                    this.v.i[0] = this.v.v[0],
                    this.v.v[1] = [t + s - a, e - i],
                    this.v.o[1] = this.v.v[1],
                    this.v.i[1] = [t + s - r, e - i],
                    this.v.v[2] = [t - s + a, e - i],
                    this.v.o[2] = [t - s + r, e - i],
                    this.v.i[2] = this.v.v[2],
                    this.v.v[3] = [t - s, e - i + a],
                    this.v.o[3] = this.v.v[3],
                    this.v.i[3] = [t - s, e - i + r],
                    this.v.v[4] = [t - s, e + i - a],
                    this.v.o[4] = [t - s, e + i - r],
                    this.v.i[4] = this.v.v[4],
                    this.v.v[5] = [t - s + a, e + i],
                    this.v.o[5] = this.v.v[5],
                    this.v.i[5] = [t - s + r, e + i],
                    this.v.v[6] = [t + s - a, e + i],
                    this.v.o[6] = [t + s - r, e + i],
                    this.v.i[6] = this.v.v[6],
                    this.v.v[7] = [t + s, e + i - a],
                    this.v.o[7] = this.v.v[7],
                    this.v.i[7] = [t + s, e + i - r])
            }
            return function(s, i) {
                this.v = {
                    v: new Array(8),
                    ...
                    this.p = l(s, i.p, 1, 0, this.dynamicProperties),
                    this.s = l(s, i.s, 1, 0, this.dynamicProperties),
                    this.r = l(s, i.r, 0, 0, this.dynamicProperties),
            ...
            return function(e, s) {
                this.elem = e,
                    ...
                    this.isTrimming = !1,
                    this.comp = e.comp,
                    this.s = l(e, s.s, 0, .01, this.dynamicProperties),
                    this.e = l(e, s.e, 0, .01, this.dynamicProperties),
                    this.o = l(e, s.o, 0, 0, this.dynamicProperties),
            ...
            function t(t, e) {
                ...
                for (s = 0; n - 1 > s; s += 1)
                    this.lengths[s] = bez.getBezierLength(i[s], i[s + 1], a[s], r[s + 1]),
                        this.totalLength += this.lengths[s].addedLength;
                e && (this.lengths[s] = bez.getBezierLength(i[s], i[0], a[s], r[0]),
                    this.totalLength += this.lengths[s].addedLength)
            }
            function e(t, e, s, i, a) {
                this.nextO[this.segmentCount] = e,
                    this.nextI[this.segmentCount + 1] = s,
                    this.nextV[this.segmentCount + 1] = i,
            ...
            function s(t) {
                this.mdf = t ? !0 : !1,
                this.prop.k && this.prop.getValue();
                var e = 0
                    , s = this.trims.length;
                ...
                if (this.mdf = this.prop.mdf ? !0 : this.mdf,
                    ...
                    for (a = 0; m > a; a += 1)
                        if (this.trims[a].isTrimming) {
                            if (r = this.trims[a].eValue,
                                    n = this.trims[a].sValue,
                                    o = this.trims[a].oValue,
                                r === n)
                                return this.v.v = this.nextV,
                                    this.v.o = this.nextO,
                                    void (this.v.i = this.nextI);
                            1 >= r ? (this.segments[0].s = this.totalLength * n,
                                this.segments[0].e = this.totalLength * r,
                                this.segments[1].vl = !1) : n >= 1 ? (this.segments[0].s = this.totalLength * (n - 1),
                                this.segments[0].e = this.totalLength * (r - 1),
                                this.segments[1].vl = !1) : (this.segments[0].s = this.totalLength * n,
                                this.segments[0].e = this.totalLength,
                                this.segments[1].s = 0,
                                this.segments[1].e = this.totalLength * (r - 1),
                            ...
                            for (this.segmentCount = 0,
                                ...
                                for (f = 0,
                                         h = 1; l > h; h++)
                                    if (d = this.lengths[h - 1].addedLength,
                                        f + d < this.segments[e].s)
                                        f += d;
                                    else {
                                        if (f > this.segments[e].e)
                                            break;
                                        this.segments[e].s <= f && this.segments[e].e >= f + d ? this.addSegment(this.v.v[h - 1], this.v.o[h - 1], this.v.i[h], this.v.v[h], this.lengths[h - 1]) : (c = bez.getNewSegment(this.v.v[h - 1], this.v.v[h], this.v.o[h - 1], this.v.i[h], (this.segments[e].s - f) / d, (this.segments[e].e - f) / d, this.lengths[h - 1]),
                                            this.addSegment(c.pt1, c.pt3, c.pt4, c.pt2)),
                                            f += d
                                    }
                                i !== !1 ? f <= this.segments[e].e && (d = this.lengths[h - 1].addedLength,
                                    this.segments[e].s <= f && this.segments[e].e >= f + d ? this.addSegment(this.v.v[h - 1], this.v.o[h - 1], this.v.i[0], this.v.v[0], this.lengths[h - 1]) : (c = bez.getNewSegment(this.v.v[h - 1], this.v.v[0], this.v.o[h - 1], this.v.i[0], (this.segments[e].s - f) / d, (this.segments[e].e - f) / d, this.lengths[h - 1]),
                                        this.addSegment(c.pt1, c.pt3, c.pt4, c.pt2))) : this.pathStarted = !1
                            }
                            i = !1
                        } else
                            this.v.v = p.v,
            ...
            return function(i, a) {
                ...
                var r, n = a.length;
                for (r = 0; n > r; r += 1)
                    a[r].closed || (this.k = a[r].trimProp.k ? !0 : this.k,
                        this.trims.push(a[r].trimProp));
                this.prop = i,
                    this.prop.numNodes ? (n = this.prop.numNodes - 1,
                        n += this.prop.closed ? 1 : 0,
                        this.lengths = new Array(n)) : this.lengths = [],
                    this.k = i.k ? !0 : this.k,
                    this.totalLength = 0,
                    this.getValue = s,
                    this.addSegment = e,
                    this.getSegmentsLength = t,
                this.k || (this.prop.getValue(),
                    this.getValue(!0))
            }
        }()
            , S = function() {
            ...
            function e(t) {
                var e = BezierFactory.getBezierEasing(this.ne.v / 100, 0, 1 - this.xe.v / 100, 1).get
                    ...
                    , h = this.data.sh;
                if (2 == h)
                    r = o === n ? t >= o ? 1 : 0 : s(0, i(.5 / (o - n) + (t - n) / (o - n), 1)),
                        r = e(r);
                else if (3 == h)
                    r = o === n ? t >= o ? 0 : 1 : 1 - s(0, i(.5 / (o - n) + (t - n) / (o - n), 1)),
                        r = e(r);
                else if (4 == h)
                    o === n ? r = t >= o ? 0 : 1 : (r = s(0, i(.5 / (o - n) + (t - n) / (o - n), 1)),
                        .5 > r ? r *= 2 : r = 1 - r);
                else if (5 == h)
                    if (o === n)
                        r = t >= o ? 0 : 1;
                    ...
                    6 == h ? r = o === n ? t >= o ? 0 : 1 : (1 + (Math.cos(Math.PI + 2 * Math.PI * (t - n) / (o - n)) + 0)) / 2 : t >= a(n) && (r = 0 > t - n ? 1 - (n - t) : s(0, i(o - t, 1)));
                return r * this.a.v
            }
            var s = Math.max
                , i = Math.min
            ...
            return function(s, i, a) {
                this.mdf = !1,
                    ...
                    this.e = "e"in i ? l(s, i.e, 0, 0, this.dynamicProperties) : {
                    ...
                    this.a = l(s, i.a, 0, .01, this.dynamicProperties),
                    this.dynamicProperties.length ? a.push(this) : this.getValue()
            }
        }()
            , w = {};
        return w.getProp = l,
    ...
    SVGRenderer.prototype.createItem = function(t, e, s, i) {
        ...
        SVGRenderer.prototype.buildItems = function(t, e, s, i, a) {
            ...
            var o;
            for (r = n - 1; r >= 0; r--)
                s[r] = this.createItem(t[r], e, i, a),
                0 === t[r].ty && (o = [],
                    this.buildItems(t[r].layers, s[r].getDomElement(), o, s[r], s[r].placeholder),
                    s[r].setElements(o)),
                t[r].td && s[r + 1].setMatte(s[r].layerId)
        }
        ,
        SVGRenderer.prototype.includeLayers = function(t, e, s) {
            ...
            for (i = 0; a > i; i += 1)
                for (r = 0; h > r; ) {
                    if (s[r].data.id == t[i].id) {
                        o = s[r],
                            s[r] = this.createItem(t[i], e, this, o),
                        0 === t[i].ty && (n = [],
                            this.buildItems(t[i].layers, s[r].getDomElement(), n, s[r], s[i].placeholder),
                            s[r].setElements(n));
                        break
                    }
                    r += 1
            ...
            for (i = 0; a > i; i += 1)
                t[i].td && s[i + 1].setMatte(s[i].layerId)
        }
        ,
        ...
        SVGRenderer.prototype.configAnimation = function(t) {
            ...
            r.setAttribute("clip-path", "url(#" + a + ")"),
        ...
        SVGRenderer.prototype.buildStage = function(t, e, s) {
            ...
            for (s || (s = this.elements),
                     i = r - 1; i >= 0; i--)
                a = e[i],
                void 0 !== a.parent && this.buildItemParenting(a, s[i], e, a.parent, s, !0),
                0 === a.ty && this.buildStage(s[i].getComposingElement(), a.layers, s[i].getElements())
        }
        ,
        SVGRenderer.prototype.buildItemParenting = function(t, e, s, i, a, r) {
            ...
            for (var n = 0, o = s.length; o > n; )
                s[n].ind == i && (e.getHierarchy().push(a[n]),
                void 0 !== s[n].parent && this.buildItemParenting(t, e, s, s[n].parent, a, !1)),
                    n += 1
        }
        ,
        ...
        CanvasRenderer.prototype.createItem = function(t, e) {
            switch (t.ty) {
                case 0:
        ...
        CanvasRenderer.prototype.buildItems = function(t, e, s) {
            ...
            var i, a = t.length;
            for (i = 0; a > i; i++)
                if (e[i] = this.createItem(t[i], s),
                    0 === t[i].ty) {
                    var r = [];
                    this.buildItems(t[i].layers, r, e[i]),
                        e[e.length - 1].setElements(r)
                }
        }
        ,
        CanvasRenderer.prototype.includeLayers = function(t, e, s) {
            ...
            for (i = 0; a > i; i += 1)
                for (r = 0; o > r; ) {
                    if (s[r].data.id == t[i].id) {
                        s[r] = this.createItem(t[i], this),
                        0 === t[i].ty && (n = [],
                            this.buildItems(t[i].layers, n, s[r]),
                            s[r].setElements(n));
                        break
                    }
                    r += 1
        ...
        CanvasRenderer.prototype.updateContainerSize = function() {
            ...
            if (this.animationItem.wrapper && this.animationItem.container ? (t = this.animationItem.wrapper.offsetWidth,
                ...
                i > s ? (this.transformCanvas.sx = t / (this.transformCanvas.w / this.renderConfig.dpr),
        ...
        CanvasRenderer.prototype.buildStage = function(t, e, s) {
            ...
            for (i = r - 1; i >= 0; i--)
                a = e[i],
                void 0 !== a.parent && this.buildItemHierarchy(a, s[i], e, a.parent, s, !0),
                0 == a.ty && this.buildStage(null , a.layers, s[i].getElements())
        }
        ,
        CanvasRenderer.prototype.buildItemHierarchy = function(t, e, s, i, a, r) {
            var n = 0
                , o = s.length;
            for (r && e.resetHierarchy(); o > n; )
                s[n].ind === i && (e.getHierarchy().push(a[n]),
                void 0 !== s[n].parent && this.buildItemHierarchy(t, e, s, s[n].parent, a, !1)),
                    n += 1
        }
        ,
            ...
            if (!(this.renderedFrame == t && this.renderConfig.clearCanvas === !0 || this.destroyed || null === t)) {
                this.renderedFrame = t,
                    ...
                    this.renderConfig.clearCanvas === !0 ? (this.reset(),
                        this.canvasContext.clearRect(0, 0, this.transformCanvas.w, this.transformCanvas.h)) : this.save(),
        ...
        HybridRenderer.prototype.createItem = function(t, e, s, i) {
            switch (t.ty) {
                case 2:
                    return this.createImage(t, e, s, i);
                case 0:
        ...
        HybridRenderer.prototype.buildItems = function(t, e, s, i, a) {
            ...
            var o, h, l = !1;
            for (r = n - 1; r >= 0; r--)
                e ? s[r] = this.createItem(t[r], e, i, a) : t[r].ddd ? (l || (l = !0,
                    o = this.getThreeDContainer()),
                    s[r] = this.createItem(t[r], o, i, a)) : (l = !1,
                    s[r] = this.createItem(t[r], this.animationItem.resizerElem, i, a)),
                0 === t[r].ty && (h = [],
                    this.buildItems(t[r].layers, s[r].getDomElement(), h, s[r], s[r].placeholder),
                    s[r].setElements(h)),
                t[r].td && s[r + 1].setMatte(s[r].layerId);
            if (this.currentContainer = this.animationItem.resizerElem,
                ...
                if (this.camera)
                    ...
                    for (n = this.threeDElements.length,
                             r = 0; n > r; r += 1)
                        this.threeDElements[0][r].style.perspective = this.threeDElements[0][r].style.webkitPerspective = Math.sqrt(Math.pow(p, 2) + Math.pow(m, 2)) + "px"
                }
        }
        ,
        HybridRenderer.prototype.includeLayers = function(t, e, s) {
            ...
            for (i = 0; a > i; i += 1)
                if (t[i].id)
                    ...
                    s.push(l),
                    0 === t[i].ty && (n = [],
                        this.buildItems(t[i].layers, l.getDomElement(), n, l),
                        l.setElements(n))
                }
            for (i = 0; a > i; i += 1)
                t[i].td && s[i + 1].setMatte(s[i].layerId)
        ...
        HybridRenderer.prototype.createCamera = function(t, e, s, i) {
            return this.camera = new HCameraElement(t,e,this.globalData,s,i),
                this.camera
        }
        ,
        ...
        HybridRenderer.prototype.configAnimation = function(t) {
            ...
            i.setAttribute("width", "1"),
                ...
                styleDiv(i),
                this.animationItem.resizerElem.appendChild(i);
        ...
        HybridRenderer.prototype.buildItemParenting = function(t, e, s, i, a, r) {
            ...
            for (var n = 0, o = s.length; o > n; )
                s[n].ind == i && (e.getHierarchy().push(a[n]),
                13 === e.data.ty && a[n].finalTransform.mProp.setInverted(),
                void 0 !== s[n].parent && this.buildItemParenting(t, e, s, s[n].parent, a, !1)),
                    n += 1
        }
        ,
        ...
        HybridRenderer.prototype.updateContainerSize = function() {
            ...
            o > n ? (t = a / this.globalData.compSize.w,
                e = a / this.globalData.compSize.w,
                s = 0,
                i = (r - this.globalData.compSize.h * (a / this.globalData.compSize.w)) / 2) : (t = r / this.globalData.compSize.h,
                e = r / this.globalData.compSize.h,
                s = (a - this.globalData.compSize.w * (r / this.globalData.compSize.h)) / 2,
                i = 0),
                this.animationItem.resizerElem.style.transform = this.animationItem.resizerElem.style.webkitTransform = "matrix3d(" + t + ",0,0,0,0," + e + ",0,0,0,0,1,0," + s + "," + i + ",0,1)"
        }
        ,
        ...
        MaskElement.prototype.renderFrame = function() {
            ...
            for (t = 0; e > t; t++)
                if ("n" !== this.masksProperties[t].mode && this.masksProperties[t].cl !== !1 && ((this.viewData[t].prop.mdf || this.firstFrame) && this.drawPath(this.masksProperties[t], this.viewData[t].prop.v, this.viewData[t]),
                    ...
                    this.storedData[t].x.v < 0 ? ("erode" !== this.storedData[t].lastOperator && (this.storedData[t].lastOperator = "erode",
                        this.storedData[t].elem.setAttribute("filter", "url(#" + this.storedData[t].filterId + ")")),
                        s.setAttribute("radius", -this.storedData[t].x.v)) : ("dilate" !== this.storedData[t].lastOperator && (this.storedData[t].lastOperator = "dilate",
        ...
        MaskElement.prototype.drawPath = function(t, e, s) {
            ...
            for (a = e.v.length,
                     i = 1; a > i; i += 1)
                1 == i && (r += " M" + bm_rnd(e.v[0][0]) + "," + bm_rnd(e.v[0][1])),
                    r += " C" + bm_rnd(e.o[i - 1][0]) + "," + bm_rnd(e.o[i - 1][1]) + " " + bm_rnd(e.i[i][0]) + "," + bm_rnd(e.i[i][1]) + " " + bm_rnd(e.v[i][0]) + "," + bm_rnd(e.v[i][1]);
            t.cl && (r += " C" + bm_rnd(e.o[i - 1][0]) + "," + bm_rnd(e.o[i - 1][1]) + " " + bm_rnd(e.i[0][0]) + "," + bm_rnd(e.i[0][1]) + " " + bm_rnd(e.v[0][0]) + "," + bm_rnd(e.v[0][1])),
            s.lastPath !== r && (t.inv ? s.elem.setAttribute("d", this.solidPath + r) : s.elem.setAttribute("d", r),
                s.lastPath = r)
        }
        ,
        ...
        BaseElement.prototype.prepareFrame = function(t) {
            ...
            for (e = 0; s > e; e += 1)
                this.dynamicProperties[e].getValue(t);
            return this.data.hasMask && this.maskManager.prepareFrame(t),
        ...
        BaseElement.prototype.init = function() {
            this.hidden = !1,
                ...
                this.lastNum = -99999,
            this.data.ef && (this.effectsManager = new EffectsManager(this.data,this,this.dynamicProperties),
        ...
        BaseElement.prototype.mask = function(t) {
        ...
        SVGBaseElement.prototype.createElements = function() {
            if (this.data.td) {
                ...
                this.data.hasMask ? (this.layerElement = document.createElementNS(svgNS, "g"),
                    ...
                    this.maskedElement = this.layerElement) : this.data.tt ? (this.matteElement = document.createElementNS(svgNS, "g"),
        ...
        SVGBaseElement.prototype.renderFrame = function(t) {
            ...
            this.data.hasMask && (this.finalTransform.matMdf && this.layerElement.setAttribute("transform", s.to2dCSS()),
        ...
        ITextElement.prototype.init = function() {
            ...
            if (e.a.length) {
                ...
                for (s = 0; r > s; s += 1)
                    ...
                    "r"in a.a && (i.a.r = PropertyFactory.getProp(this, a.a.r, 0, degToRads, this.dynamicProperties)),
                    "rx"in a.a && (i.a.rx = PropertyFactory.getProp(this, a.a.rx, 0, degToRads, this.dynamicProperties)),
                    "ry"in a.a && (i.a.ry = PropertyFactory.getProp(this, a.a.ry, 0, degToRads, this.dynamicProperties)),
                    "sk"in a.a && (i.a.sk = PropertyFactory.getProp(this, a.a.sk, 0, degToRads, this.dynamicProperties)),
                    "sa"in a.a && (i.a.sa = PropertyFactory.getProp(this, a.a.sa, 0, degToRads, this.dynamicProperties)),
                    "s"in a.a && (i.a.s = PropertyFactory.getProp(this, a.a.s, 1, .01, this.dynamicProperties)),
                    "a"in a.a && (i.a.a = PropertyFactory.getProp(this, a.a.a, 1, 0, this.dynamicProperties)),
                    "o"in a.a && (i.a.o = PropertyFactory.getProp(this, a.a.o, 0, .01, this.dynamicProperties)),
                    "p"in a.a && (i.a.p = PropertyFactory.getProp(this, a.a.p, 1, 0, this.dynamicProperties)),
                    "sw"in a.a && (i.a.sw = PropertyFactory.getProp(this, a.a.sw, 0, 0, this.dynamicProperties)),
                    "sc"in a.a && (i.a.sc = PropertyFactory.getProp(this, a.a.sc, 1, 0, this.dynamicProperties)),
                    "fc"in a.a && (i.a.fc = PropertyFactory.getProp(this, a.a.fc, 1, 0, this.dynamicProperties)),
                    "fh"in a.a && (i.a.fh = PropertyFactory.getProp(this, a.a.fh, 0, 0, this.dynamicProperties)),
                    "fs"in a.a && (i.a.fs = PropertyFactory.getProp(this, a.a.fs, 0, .01, this.dynamicProperties)),
                    "fb"in a.a && (i.a.fb = PropertyFactory.getProp(this, a.a.fb, 0, .01, this.dynamicProperties)),
                    "t"in a.a && (i.a.t = PropertyFactory.getProp(this, a.a.t, 0, 0, this.dynamicProperties)),
                        i.s = PropertyFactory.getTextSelectorProp(this, a.s, this.dynamicProperties),
                        i.s.t = a.s.t,
                        this.viewData.a[s] = i
            } else
                this.viewData.a = [];
        ...
        ITextElement.prototype.createPathShape = function(t, e) {
            ...
            for (s = 0; n > s; s += 1) {
                for (a = e[s].ks.k.i.length,
                         r = e[s].ks.k,
                         i = 1; a > i; i += 1)
                    1 == i && (o += " M" + t.applyToPointStringified(r.v[0][0], r.v[0][1])),
                        o += " C" + t.applyToPointStringified(r.o[i - 1][0], r.o[i - 1][1]) + " " + t.applyToPointStringified(r.i[i][0], r.i[i][1]) + " " + t.applyToPointStringified(r.v[i][0], r.v[i][1]);
                o += " C" + t.applyToPointStringified(r.o[i - 1][0], r.o[i - 1][1]) + " " + t.applyToPointStringified(r.i[0][0], r.i[0][1]) + " " + t.applyToPointStringified(r.v[0][0], r.v[0][1]),
                    o += "z"
            }
            return o
        }
    ...
    ITextElement.prototype.getMeasures = function() {
        ...
        if (this.maskPath) {
            ...
            if (0 > v && l.closed)
                for (m.tLength < Math.abs(v) && (v = -Math.abs(v) % m.tLength),
                         g = k.length - 1,
                         y = k[g].bezierData.points,
                         b = y.length - 1; 0 > v; )
                    v += y[b].partialLength,
                        b -= 1,
                    0 > b && (g -= 1,
        ...
        i = h.length,
            t = 0,
            e = 0;
        var w, D, T, M, I, F = 1.2 * n.t.d.s * .714, A = !0, V = this.viewData, N = Array.apply(null , {
            length: i
        });
        this.lettersChangedFlag = !1,
            M = V.a.length;
        ...
        for (s = 0; i > s; s += 1)
            if (a.reset(),
                ...
                if (this.maskPath) {
                    ...
                    K !== h[s].ind && (h[K] && (v += h[K].extra),
                        v += h[s].an / 2,
                        K = h[s].ind),
                        v += V.m.a.v[0] * h[s].an / 200;
                    var it = 0;
                    for (T = 0; M > T; T += 1)
                        w = V.a[T].a,
                        "p"in w && (D = V.a[T].s,
                            B = D.getMult(h[s].anIndexes[T]),
                            it += B.length ? w.p.v[0] * B[0] : w.p.v[0] * B);
                    for (P = !0; P; )
                        E + x >= v + it || !y ? (S = (v + it - E) / c.partialLength,
                            H = u.point[0] + (c.point[0] - u.point[0]) * S,
                            R = u.point[1] + (c.point[1] - u.point[1]) * S,
                            a.translate(0, -(V.m.a.v[1] * F / 100) + e),
                            P = !1) : y && (E += c.partialLength,
                            b += 1,
                        b >= y.length && (b = 0,
                            g += 1,
                            k[g] ? y = k[g].bezierData.points : l.closed ? (b = 0,
                                g = 0,
                                y = k[g].bezierData.points) : (E -= c.partialLength,
                                y = null )),
                        y && (u = c,
                            c = y[b],
                            x = c.partialLength));
                    ...
                    _ = h[s].an / 2 - h[s].add,
                        a.translate(-_, 0, 0),
                        a.translate(-V.m.a.v[0] * h[s].an / 200, -V.m.a.v[1] * F / 100, 0);
                for (st += h[s].l / 2,
                         T = 0; M > T; T += 1)
                    w = V.a[T].a,
                    "t"in w && (D = V.a[T].s,
                        B = D.getMult(h[s].anIndexes[T]),
                        this.maskPath ? v += B.length ? w.t * B[0] : w.t * B : t += B.length ? w.t.v * B[0] : w.t.v * B);
                for (st += h[s].l / 2,
                     o.strokeWidthAnim && (j = n.t.d.sw || 0),
                     o.strokeColorAnim && (O = n.t.d.sc ? [n.t.d.sc[0], n.t.d.sc[1], n.t.d.sc[2]] : [0, 0, 0]),
                     o.fillColorAnim && (G = [n.t.d.fc[0], n.t.d.fc[1], n.t.d.fc[2]]),
                         T = 0; M > T; T += 1)
                    w = V.a[T].a,
                    "a"in w && (D = V.a[T].s,
                        B = D.getMult(h[s].anIndexes[T]),
                        B.length ? a.translate(-w.a.v[0] * B[0], -w.a.v[1] * B[1], w.a.v[2] * B[2]) : a.translate(-w.a.v[0] * B, -w.a.v[1] * B, w.a.v[2] * B));
                for (T = 0; M > T; T += 1)
                    w = V.a[T].a,
                    "s"in w && (D = V.a[T].s,
                        B = D.getMult(h[s].anIndexes[T]),
                        B.length ? a.scale(1 + (w.s.v[0] - 1) * B[0], 1 + (w.s.v[1] - 1) * B[1], 1) : a.scale(1 + (w.s.v[0] - 1) * B, 1 + (w.s.v[1] - 1) * B, 1));
                for (T = 0; M > T; T += 1) {
                    if (w = V.a[T].a,
                            D = V.a[T].s,
                            B = D.getMult(h[s].anIndexes[T]),
                        "sk"in w && (B.length ? a.skewFromAxis(-w.sk.v * B[0], w.sa.v * B[1]) : a.skewFromAxis(-w.sk.v * B, w.sa.v * B)),
                        "r"in w && a.rotateZ(B.length ? -w.r.v * B[2] : -w.r.v * B),
                        "ry"in w && a.rotateY(B.length ? w.ry.v * B[1] : w.ry.v * B),
                        "rx"in w && a.rotateX(B.length ? w.rx.v * B[0] : w.rx.v * B),
                        "o"in w && (z += B.length ? (w.o.v * B[0] - z) * B[0] : (w.o.v * B - z) * B),
                        o.strokeWidthAnim && "sw"in w && (j += B.length ? w.sw.v * B[0] : w.sw.v * B),
                        o.strokeColorAnim && "sc"in w)
                        for (W = 0; 3 > W; W += 1)
                            O[W] = Math.round(B.length ? O[W] + (w.sc.v[W] - O[W]) * B[0] : O[W] + (w.sc.v[W] - O[W]) * B);
                    if (o.fillColorAnim) {
                        if ("fc"in w)
                            for (W = 0; 3 > W; W += 1)
                                G[W] = Math.round(B.length ? G[W] + (w.fc.v[W] - G[W]) * B[0] : G[W] + (w.fc.v[W] - G[W]) * B);
                        "fh"in w && (G = B.length ? addHueToRGB(G, w.fh.v * B[0]) : addHueToRGB(G, w.fh.v * B)),
                        "fs"in w && (G = B.length ? addSaturationToRGB(G, w.fs.v * B[0]) : addSaturationToRGB(G, w.fs.v * B)),
                        "fb"in w && (G = B.length ? addBrightnessToRGB(G, w.fb.v * B[0]) : addBrightnessToRGB(G, w.fb.v * B))
                    }
                }
                for (T = 0; M > T; T += 1)
                    w = V.a[T].a,
                    "p"in w && (D = V.a[T].s,
                        B = D.getMult(h[s].anIndexes[T]),
                        this.maskPath ? B.length ? a.translate(0, w.p.v[1] * B[0], -w.p.v[2] * B[1]) : a.translate(0, w.p.v[1] * B, -w.p.v[2] * B) : B.length ? a.translate(w.p.v[0] * B[0], w.p.v[1] * B[1], -w.p.v[2] * B[2]) : a.translate(w.p.v[0] * B, w.p.v[1] * B, -w.p.v[2] * B));
                if (o.strokeWidthAnim && (X = 0 > j ? 0 : j),
                    o.strokeColorAnim && (q = "rgb(" + O[0] + "," + O[1] + "," + O[2] + ")"),
                    o.fillColorAnim && (Y = "rgb(" + G[0] + "," + G[1] + "," + G[2] + ")"),
                        this.maskPath) {
                    if (n.t.p.p) {
                        C = (c.point[1] - u.point[1]) / (c.point[0] - u.point[0]);
                        var at = 180 * Math.atan(C) / Math.PI;
                        c.point[0] < u.point[0] && (at += 180),
                            a.rotate(-at * Math.PI / 180)
                    }
                    a.translate(H, R, 0),
                        a.translate(V.m.a.v[0] * h[s].an / 200, V.m.a.v[1] * F / 100, 0),
                        v -= V.m.a.v[0] * h[s].an / 200,
                    h[s + 1] && K !== h[s + 1].ind && (v += h[s].an / 2,
                        v += o.tr / 1e3 * n.t.d.s)
                } else {
                    switch (a.translate(t, e, 0),
                    o.ps && a.translate(o.ps[0], o.ps[1] + o.ascent, 0),
                        o.j) {
                        case 1:
                ...
                "html" === r ? Z = a.toCSS() : "svg" === r ? Z = a.to2dCSS() : J = [a.props[0], a.props[1], a.props[2], a.props[3], a.props[4], a.props[5], a.props[6], a.props[7], a.props[8], a.props[9], a.props[10], a.props[11], a.props[12], a.props[13], a.props[14], a.props[15]],
                    U = z,
                    L = this.renderedLetters[s],
                    !L || L.o === U && L.sw === X && L.sc === q && L.fc === Y ? "svg" !== r && "html" !== r || L && L.m === Z ? "canvas" !== r || L && L.props[0] === J[0] && L.props[1] === J[1] && L.props[4] === J[4] && L.props[5] === J[5] && L.props[12] === J[12] && L.props[13] === J[13] ? I = L : (this.lettersChangedFlag = !0,
                        I = new LetterProps(U,X,q,Y,null ,J)) : (this.lettersChangedFlag = !0,
                        I = new LetterProps(U,X,q,Y,Z)) : (this.lettersChangedFlag = !0,
                        I = new LetterProps(U,X,q,Y,Z,J)),
                    this.renderedLetters[s] = I
            }
    }
    ,
    ...
    SVGTextElement.prototype.createElements = function() {
        ...
        this.innerElem = document.createElementNS(svgNS, "g"),
            t.fc ? this.innerElem.setAttribute("fill", "rgb(" + t.fc[0] + "," + t.fc[1] + "," + t.fc[2] + ")") : this.innerElem.setAttribute("fill", "rgba(0,0,0,0)"),
        t.sc && (this.innerElem.setAttribute("stroke", "rgb(" + t.sc[0] + "," + t.sc[1] + "," + t.sc[2] + ")"),
        ...
        if (e.fClass)
            this.innerElem.setAttribute("class", e.fClass);
        else {
            this.innerElem.setAttribute("font-family", e.fFamily);
            var s = t.fWeight
                , i = t.fStyle;
            this.innerElem.setAttribute("font-style", i),
        ...
        if (r = n.length) {
            ...
            if (m)
                var f = 0
                    ...
                    , y = !0;
            for (a = 0; r > a; a += 1) {
                if (this.globalData.fontManager.chars ? m && 0 !== a || (o = document.createElementNS(svgNS, "path")) : o = document.createElementNS(svgNS, "text"),
                    ...
                    this.globalData.fontManager.chars && l.scale(t.s / 100, t.s / 100),
                        m) {
                    switch (t.ps && l.translate(t.ps[0], t.ps[1] + t.ascent, 0),
                        t.j) {
                        case 1:
    ...
    SVGTextElement.prototype.hide = function() {
        this.hidden || (this.innerElem.style.display = "none",
            this.hidden = !0)
    }
    ,
    SVGTextElement.prototype.renderFrame = function(t) {
        ...
        if (this.hidden && (this.hidden = !1,
            ...
            this.data.hasMask || (this.finalTransform.matMdf && this.innerElem.setAttribute("transform", this.finalTransform.mat.to2dCSS()),
            this.finalTransform.opMdf && this.innerElem.setAttribute("opacity", this.finalTransform.opacity)),
    ...
    var PlaceHolderElement = function(t, e, s) {
            if (this.data = t,
                ...
                i.setAttribute("id", this.data.id),
                    e.appendChild(i),
                    this.phElement = i
            }
    ...
    PlaceHolderElement.prototype.prepareFrame = function() {}
        ...
        ICompElement.prototype.prepareFrame = function(t) {
            if (this.parent.prepareFrame.call(this, t),
                ...
                for (s = 0; i > s; s += 1)
                    this.elements[s].prepareFrame(e - this.layers[s].st)
            }
        }
        ,
        ...
        IImageElement.prototype.renderFrame = function(t) {
            ...
            this.data.hasMask || ((this.finalTransform.matMdf || this.firstFrame) && this.innerElem.setAttribute("transform", this.finalTransform.mat.to2dCSS()),
        ...
        IShapeElement.prototype.searchShapes = function(t, e, s, i) {
            ...
            for (a = o; a >= 0; a -= 1)
                if ("fl" == t[a].ty || "st" == t[a].ty) {
                    e[a] = {};
                    var p;
                    if (e[a].c = PropertyFactory.getProp(this, t[a].c, 1, null , s),
                            e[a].o = PropertyFactory.getProp(this, t[a].o, 0, .01, s),
                        "st" == t[a].ty) {
                        if (p = document.createElementNS(svgNS, "g"),
                                p.style.strokeLinecap = this.lcEnum[t[a].lc] || "round",
                                p.style.strokeLinejoin = this.ljEnum[t[a].lj] || "round",
                                p.style.fillOpacity = 0,
                            1 == t[a].lj && (p.style.strokeMiterlimit = t[a].ml),
                            e[a].c.k || (p.style.stroke = "rgb(" + e[a].c.v[0] + "," + e[a].c.v[1] + "," + e[a].c.v[2] + ")"),
                            e[a].o.k || (p.style.strokeOpacity = e[a].o.v),
                                e[a].w = PropertyFactory.getProp(this, t[a].w, 0, null , s),
                            e[a].w.k || (p.style.strokeWidth = e[a].w.v),
                                t[a].d) {
                            var m = PropertyFactory.getDashProp(this, t[a].d, "svg", s);
                            m.k || (p.style.strokeDasharray = m.dasharray,
                                p.style.strokeDashoffset = m.dashoffset),
                                e[a].d = m
                        }
                    } else
                        p = document.createElementNS(svgNS, "path"),
                        e[a].c.k || (p.style.fill = "rgb(" + e[a].c.v[0] + "," + e[a].c.v[1] + "," + e[a].c.v[2] + ")"),
                        e[a].o.k || (p.style.fillOpacity = e[a].o.v);
                    this.shapesContainer.appendChild(p),
                        ...
                        e[a].style = this.stylesList[this.stylesList.length - 1],
                        h.push(e[a].style)
                } else if ("gr" == t[a].ty)
                    e[a] = {
                        it: []
                    ...
                    var f = 4;
                    "rc" == t[a].ty ? f = 5 : "el" == t[a].ty ? f = 6 : "sr" == t[a].ty && (f = 7),
                    i.length && (t[a].trimmed = !0),
                        e[a].sh = PropertyFactory.getShapeProp(this, t[a], f, s, i),
                        n = this.stylesList.length;
                    var d, c = !1, u = !1;
                    for (r = 0; n > r; r += 1)
                        this.stylesList[r].closed || ("st" === this.stylesList[r].type ? (c = !0,
                            d = document.createElementNS(svgNS, "path"),
                            this.stylesList[r].pathElement.appendChild(d),
                            e[a].elements.push({
        ...
        IShapeElement.prototype.renderFrame = function(t) {
            ...
            this.finalTransform.matMdf && !this.data.hasMask && this.shapesContainer.setAttribute("transform", this.finalTransform.mat.to2dCSS()),
        ...
        IShapeElement.prototype.renderShape = function(t, e, s, i) {
            ...
            for (n = t,
                ...
                if ("tr" == e[a].ty) {
                    ...
                    "sh" == e[a].ty || "el" == e[a].ty || "rc" == e[a].ty || "sr" == e[a].ty ? this.renderPath(e[a], s[a], n) : "fl" == e[a].ty ? this.renderFill(e[a], s[a], n) : "st" == e[a].ty ? this.renderStroke(e[a], s[a], n) : "gr" == e[a].ty ? this.renderShape(n, e[a].it, s[a].it) : "tm" == e[a].ty;
            if (i) {
                for (r = this.stylesList.length,
                         a = 0; r > a; a += 1)
                    "0" === this.stylesList[a].ld && (this.stylesList[a].ld = "1",
                        this.stylesList[a].pathElement.style.display = "block"),
                    "fl" === this.stylesList[a].type && (this.stylesList[a].mdf || this.firstFrame) && this.stylesList[a].pathElement.setAttribute("d", this.stylesList[a].d);
                this.firstFrame && (this.firstFrame = !1)
            }
        }
        ,
        IShapeElement.prototype.renderPath = function(t, e, s) {
            ...
            if (r.v) {
                ...
                if (o) {
                    var h = r.s ? r.s : [];
                    for (a = 1; i > a; a += 1)
                        h[a - 1] ? n += " M" + s.mat.applyToPointStringified(h[a - 1][0], h[a - 1][1]) : 1 == a && (n += " M" + s.mat.applyToPointStringified(r.v[0][0], r.v[0][1])),
                            n += " C" + s.mat.applyToPointStringified(r.o[a - 1][0], r.o[a - 1][1]) + " " + s.mat.applyToPointStringified(r.i[a][0], r.i[a][1]) + " " + s.mat.applyToPointStringified(r.v[a][0], r.v[a][1]);
                    1 == i && (n += h[0] ? " M" + s.mat.applyToPointStringified(h[0][0], h[0][1]) : " M" + s.mat.applyToPointStringified(r.v[0][0], r.v[0][1])),
                    i && t.closed && (!t.trimmed || r.c) && (n += " C" + s.mat.applyToPointStringified(r.o[a - 1][0], r.o[a - 1][1]) + " " + s.mat.applyToPointStringified(r.i[0][0], r.i[0][1]) + " " + s.mat.applyToPointStringified(r.v[0][0], r.v[0][1]),
                        n += "z"),
                        e.lStr = n
                } else
                    n = e.lStr;
                for (i = e.elements.length,
                         a = 0; i > a; a += 1)
                    "st" === e.elements[a].ty ? ((e.sh.mdf || this.firstFrame) && e.elements[a].el.setAttribute("d", n),
                    s.matMdf || this.firstFrame) : (e.elements[a].st.mdf = o ? !0 : e.elements[a].st.mdf,
                        e.elements[a].st.d += n)
            }
        }
        ,
        IShapeElement.prototype.renderFill = function(t, e, s) {
            var i = e.style;
            (e.c.mdf || this.firstFrame) && (i.pathElement.style.fill = "rgb(" + bm_floor(e.c.v[0]) + "," + bm_floor(e.c.v[1]) + "," + bm_floor(e.c.v[2]) + ")"),
            (e.o.mdf || s.opMdf || this.firstFrame) && (i.pathElement.style.fillOpacity = e.o.v * s.opacity)
        }
        ,
        IShapeElement.prototype.renderStroke = function(t, e, s) {
            var i = e.style
                , a = e.d;
            a && a.k && (a.mdf || this.firstFrame) && (i.pathElement.style.strokeDasharray = a.dasharray,
                i.pathElement.style.strokeDashoffset = a.dashoffset),
            (e.c.mdf || this.firstFrame) && (i.pathElement.style.stroke = "rgb(" + bm_floor(e.c.v[0]) + "," + bm_floor(e.c.v[1]) + "," + bm_floor(e.c.v[2]) + ")"),
            (e.o.mdf || s.opMdf || this.firstFrame) && (i.pathElement.style.strokeOpacity = e.o.v * s.opacity),
            (e.w.mdf || this.firstFrame) && (i.pathElement.style.strokeWidth = e.w.v)
        }
        ,
        ...
        CVBaseElement.prototype.renderFrame = function(t) {
            ...
            this.data.hasMask && (this.globalData.renderer.save(!0),
                this.maskManager.renderFrame(s)),
                this.isVisible
        }
        ,
            ...
            for (e = 0; o > e; e++)
                if ("n" !== this.masksProperties[e].mode) {
                    ...
                    this.masksProperties[e].inv && (n.moveTo(0, 0),
                        n.lineTo(this.globalData.compWidth, 0),
                        n.lineTo(this.globalData.compWidth, this.globalData.compHeight),
                        n.lineTo(0, this.globalData.compHeight),
                        n.lineTo(0, 0)),
                        r = this.viewData[e].v,
                        s = t.applyToPointArray(r.v[0][0], r.v[0][1], 0),
                        n.moveTo(s[0], s[1]);
                    var l, p = r.v.length;
                    for (l = 1; p > l; l++)
                        s = t.applyToPointArray(r.o[l - 1][0], r.o[l - 1][1], 0),
                            i = t.applyToPointArray(r.i[l][0], r.i[l][1], 0),
                            a = t.applyToPointArray(r.v[l][0], r.v[l][1], 0),
                            n.bezierCurveTo(s[0], s[1], i[0], i[1], a[0], a[1]);
                    s = t.applyToPointArray(r.o[l - 1][0], r.o[l - 1][1], 0),
                        i = t.applyToPointArray(r.i[0][0], r.i[0][1], 0),
                        a = t.applyToPointArray(r.v[0][0], r.v[0][1], 0),
                        n.bezierCurveTo(s[0], s[1], i[0], i[1], a[0], a[1])
                }
            h && n.clip()
        }
            ...
            for (a = h; a >= 0; a -= 1)
                if ("fl" == t[a].ty || "st" == t[a].ty) {
                    if (o = {
                            ...
                            e[a] = {},
                            e[a].c = PropertyFactory.getProp(this, t[a].c, 1, null , s),
                        e[a].c.k || (o.co = "rgb(" + bm_floor(e[a].c.v[0]) + "," + bm_floor(e[a].c.v[1]) + "," + bm_floor(e[a].c.v[2]) + ")"),
                            e[a].o = PropertyFactory.getProp(this, t[a].o, 0, .01, s),
                        "st" == t[a].ty && (o.lc = this.lcEnum[t[a].lc] || "round",
                            o.lj = this.ljEnum[t[a].lj] || "round",
                        1 == t[a].lj && (o.ml = t[a].ml),
                            e[a].w = PropertyFactory.getProp(this, t[a].w, 0, null , s),
                        e[a].w.k || (o.wi = e[a].w.v),
                            t[a].d)) {
                        var m = PropertyFactory.getDashProp(this, t[a].d, "canvas", s);
                        e[a].d = m,
                        e[a].d.k || (o.da = e[a].d.dasharray,
                            o["do"] = e[a].d.dashoffset)
                    }
                    ...
                    var d = !1
                        , c = !1;
                    for (r = 0; n > r; r += 1)
                        this.stylesList[r].closed || (this.stylesList[r].elements.push(e[a]),
                            "st" === this.stylesList[r].type ? d = !0 : c = !0);
                    e[a].st = d,
                        e[a].fl = c
                } else if ("tm" == t[a].ty) {
                    var u = {
        ...
        CVShapeElement.prototype.renderFrame = function(t) {
            this.parent.renderFrame.call(this, t) !== !1 && (this.transformHelper.mat.reset(),
                this.transformHelper.opacity = this.finalTransform.opacity,
                this.transformHelper.matMdf = !1,
                this.transformHelper.opMdf = this.finalTransform.opMdf,
        ...
        CVShapeElement.prototype.renderShape = function(t, e, s, i) {
            ...
            if (i) {
                ...
                for (v.save(),
                         v.ctxTransform(this.finalTransform.mat.props),
                         a = 0; r > a; a += 1)
                    if (y = this.stylesList[a].type,
                        "st" !== y || 0 !== this.stylesList[a].wi) {
                        for (v.save(),
                                 c = this.stylesList[a].elements,
                                 m = c.length,
                                 "st" === y ? (g.strokeStyle = this.stylesList[a].co,
                                     g.lineWidth = this.stylesList[a].wi,
                                     g.lineCap = this.stylesList[a].lc,
                                     g.lineJoin = this.stylesList[a].lj,
                                     g.miterLimit = this.stylesList[a].ml || 0) : g.fillStyle = this.stylesList[a].co,
                                 v.ctxOpacity(this.stylesList[a].coOp),
                             "st" !== y && g.beginPath(),
                                 p = 0; m > p; p += 1) {
                            for ("st" === y && (g.beginPath(),
                                this.stylesList[a].da ? (g.setLineDash(this.stylesList[a].da),
                                    g.lineDashOffset = this.stylesList[a]["do"],
                                    this.globalData.isDashed = !0) : this.globalData.isDashed && (g.setLineDash(this.dashResetter),
                                    this.globalData.isDashed = !1)),
                                     u = c[p].trNodes,
                                     d = u.length,
                                     f = 0; d > f; f += 1)
                                "m" == u[f].t ? g.moveTo(u[f].p[0], u[f].p[1]) : "c" == u[f].t ? g.bezierCurveTo(u[f].p1[0], u[f].p1[1], u[f].p2[0], u[f].p2[1], u[f].p3[0], u[f].p3[1]) : g.closePath();
                            "st" === y && g.stroke()
                        }
                        "st" !== y && g.fill(),
                            v.restore()
        ...
        CVShapeElement.prototype.renderFill = function(t, e, s) {
            ...
            (e.o.mdf || s.opMdf || this.firstFrame) && (i.coOp = e.o.v * s.opacity)
        }
        ,
        CVShapeElement.prototype.renderStroke = function(t, e, s) {
            var i = e.style
                , a = e.d;
            a && (a.mdf || this.firstFrame) && (i.da = a.dasharray,
                i["do"] = a.dashoffset),
            (e.c.mdf || this.firstFrame) && (i.co = "rgb(" + bm_floor(e.c.v[0]) + "," + bm_floor(e.c.v[1]) + "," + bm_floor(e.c.v[2]) + ")"),
            (e.o.mdf || s.opMdf || this.firstFrame) && (i.coOp = e.o.v * s.opacity),
        ...
        CVTextElement.prototype.createElements = function() {
            ...
            var t = this.data.t.d
                , e = !1;
            t.fc ? (e = !0,
                this.values.fill = "rgb(" + t.fc[0] + "," + t.fc[1] + "," + t.fc[2] + ")") : this.values.fill = "rgba(0,0,0,0)",
                this.fill = e;
            var s = !1;
            t.sc && (s = !0,
                this.values.stroke = "rgb(" + t.sc[0] + "," + t.sc[1] + "," + t.sc[2] + ")",
            ...
            for (i = 0; a > i; i += 1) {
                ...
                if (l = h ? h.data : null ,
                    ...
                    for (y = new Array(c),
                             d = 0; c > d; d += 1) {
                        for (m = f[d].ks.k.i.length,
                                 u = f[d].ks.k,
                                 v = [],
                                 p = 1; m > p; p += 1)
                            1 == p && v.push(o.applyToX(u.v[0][0], u.v[0][1], 0), o.applyToY(u.v[0][0], u.v[0][1], 0)),
                                v.push(o.applyToX(u.o[p - 1][0], u.o[p - 1][1], 0), o.applyToY(u.o[p - 1][0], u.o[p - 1][1], 0), o.applyToX(u.i[p][0], u.i[p][1], 0), o.applyToY(u.i[p][0], u.i[p][1], 0), o.applyToX(u.v[p][0], u.v[p][1], 0), o.applyToY(u.v[p][0], u.v[p][1], 0));
                        v.push(o.applyToX(u.o[p - 1][0], u.o[p - 1][1], 0), o.applyToY(u.o[p - 1][0], u.o[p - 1][1], 0), o.applyToX(u.i[0][0], u.i[0][1], 0), o.applyToY(u.i[0][0], u.i[0][1], 0), o.applyToX(u.v[0][0], u.v[0][1], 0), o.applyToY(u.v[0][0], u.v[0][1], 0)),
                            y[d] = v
                    }
                } else
                    y = [];
                    ...
                    if (!p[i].n) {
                        if (m = l[i],
                            m && (this.globalData.renderer.save(),
                                ...
                                this.fill) {
                            for (m && m.fc ? c !== m.fc && (c = m.fc,
                                e.fillStyle = m.fc) : c !== this.values.fill && (c = this.values.fill,
                                ...
                                for (d = f[r],
                                         ...
                                         o = 2; h > o; o += 6)
                                    this.globalData.canvasContext.bezierCurveTo(d[o], d[o + 1], d[o + 2], d[o + 3], d[o + 4], d[o + 5]);
        ...
        HCompElement.prototype.createElements = function() {
            if (this.layerElement = document.createElement("div"),
    ...
    extendPrototype(IShapeElement, HShapeElement),
        ...
        HShapeElement.prototype.createElements = function() {
            ...
            styleDiv(t);
            var e = document.createElementNS(svgNS, "svg");
            if (999999 === this.data.bounds.l,
                    e.setAttribute("width", this.data.bounds.r - this.data.bounds.l),
                    e.setAttribute("height", this.data.bounds.b - this.data.bounds.t),
                    e.setAttribute("viewBox", this.data.bounds.l + " " + this.data.bounds.t + " " + (this.data.bounds.r - this.data.bounds.l) + " " + (this.data.bounds.b - this.data.bounds.t)),
                    e.style.transform = e.style.webkitTransform = "translate(" + this.data.bounds.l + "px," + this.data.bounds.t + "px)",
                    this.data.hasMask) {
        ...
        HTextElement.prototype.createElements = function() {
            ...
            this.parentContainer.appendChild(e),
                this.innerElem.style.color = this.innerElem.style.fill = t.fc ? "rgb(" + t.fc[0] + "," + t.fc[1] + "," + t.fc[2] + ")" : "rgba(0,0,0,0)",
            t.sc && (this.innerElem.style.stroke = "rgb(" + t.sc[0] + "," + t.sc[1] + "," + t.sc[2] + ")",
            ...
            for (o = 0; h > o; o += 1) {
                if (this.globalData.fontManager.chars ? (p = document.createElementNS(svgNS, "path"),
                    this.isMasked || (m = document.createElement("div"),
                        ...
                        p.setAttribute("stroke-miterlimit", "4")) : this.isMasked ? p = document.createElementNS(svgNS, "text") : (m = document.createElement("span"),
                        styleDiv(m),
                    ...
                    if (y = v ? v.data : null ,
                        ...
                        if (y && y.shapes) {
                            ...
                            f.setAttribute("width", b - P),
                                f.setAttribute("height", k - E),
                                f.setAttribute("viewBox", P + " " + E + " " + (b - P) + " " + (k - E)),
                                f.style.transform = f.style.webkitTransform = "translate(" + P + "px," + E + "px)",
                                l[o].yOffset = E
                        } else
                    ...
                    p.textContent = l[o].val,
                        ...
                        this.isMasked ? this.innerElem.appendChild(p) : (this.innerElem.appendChild(m),
                            p.style.transform = p.style.webkitTransform = "translate3d(0," + -t.s / 1.2 + "px,0)");
    ...
    var animationManager = function() {
            function t(e) {
                var s = 0
                    , i = e.target;
                for (i.removeEventListener("destroy", t); P > s; )
                    g[s].animation === i && (g.splice(s, 1),
                        s -= 1,
                        P -= 1),
                        s += 1
            }
            function e(e, s) {
                if (!e)
                    return null ;
                for (var i = 0; P > i; ) {
                    if (g[i].elem == e && null !== g[i].elem)
                        return g[i].animation;
                    i += 1
                }
                var a = new AnimationItem;
                return a.setData(e, s),
                    a.addEventListener("destroy", t),
                    g.push({
                        elem: e,
                        animation: a
                    }),
            ...
            function i(t, e) {
                var s;
                for (s = 0; P > s; s += 1)
                    g[s].animation.setSpeed(t, e)
            }
            function a(t, e) {
                var s;
                for (s = 0; P > s; s += 1)
                    g[s].animation.setDirection(t, e)
            }
            function r(t) {
                var e;
                for (e = 0; P > e; e += 1)
            ...
            function n(t, e) {
                ...
                var s;
                for (s = 0; P > s; s += 1)
                    g[s].animation.moveFrame(t, e)
            }
            function o(t) {
                var e, s = t - b;
                for (e = 0; P > e; e += 1)
                    g[e].animation.advanceTime(s);
                b = t,
            ...
            function p(t, e, s) {
                var i;
                for (i = 0; P > i; i += 1)
                    g[i].animation.goToAndStop(t, e, s)
            }
            function m(t) {
                var e;
                for (e = 0; P > e; e += 1)
    ...
    AnimationItem.prototype.setParams = function(t) {
        ...
        AnimationItem.prototype.setData = function(t, e) {
            ...
            "" === a || (s.loop = "false" === a ? !1 : "true" === a ? !0 : parseInt(a)),
                s.name = i.getNamedItem("data-name") ? i.getNamedItem("data-name").value : i.getNamedItem("data-bm-name") ? i.getNamedItem("data-bm-name").value : i.getNamedItem("bm-name") ? i.getNamedItem("bm-name").value : "";
        ...
        AnimationItem.prototype.loadNextSegment = function() {
            ...
            this.segmentPos += 1,
                ...
                s.onreadystatechange = function() {
                    if (4 == s.readyState)
                        if (200 == s.status)
                            i.includeLayers(JSON.parse(s.responseText));
                        else
                            try {
        ...
        AnimationItem.prototype.gotoFrame = function() {
            this.currentFrame = subframeEnabled ? this.currentRawFrame : this.math.floor(this.currentRawFrame),
